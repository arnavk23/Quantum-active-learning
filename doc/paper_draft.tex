...
\begin{table}[h!]
    ...
    \label{tab:results}
\end{table}
    \item Wu, Jun et al. "An Empirical Study on Customer Segmentation by Purchase Behaviors Using a RFM Model and K-Means Algorithm." Mathematical Problems in Engineering, 2020. 
    \item Bayesian Prior Construction for UQ in First-Principles Statistical Mechanics. arXiv:2509.07326.
    \item Quantum Chemistry Relaxations via ML Interatomic Potentials. arXiv:2506.23008.
    \item Qiskit textbook, Materials Project documentation.
\end{enumerate}
