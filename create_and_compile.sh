...
if [ -f "quantum_paper_fixed.pdf" ]; then
    ...
    echo ""
    echo "FIGURE 3 LEGEND FIX APPLIED:"
    echo "   - Legend moved to top-left corner (north west)"
    echo "   - Legend positioned at coordinates (0.02,0.98)"
    echo "   - White background with 80% opacity for readability"
    echo "   - Tiny font size for compact legend"
    echo "   - Figure height increased to 6.5cm for better visibility"
